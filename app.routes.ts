...
import { AdminpackagesComponent } from './adminpackages/adminpackages.component';
import { AduppackageComponent } from './aduppackage/aduppackage.component';
import { AdmintrainComponent } from './admintrain/admintrain.component';
import { AdhotelviewComponent } from './adhotelview/adhotelview.component';
import { TrainfillComponent } from './trainfill/trainfill.component';
import { TrainsearchComponent } from './trainsearch/trainsearch.component';
import { TrainpageComponent } from './trainpage/trainpage.component';
...
export const routes: Routes = [
    ...
    {path:'adminpackage',component:AdminpackagesComponent},
    {path:'aduppackage',component:AduppackageComponent},
    {path:'admintrain',component:AdmintrainComponent},
    {path:'adhotelview',component:AdhotelviewComponent},
    {path:'trainfill',component:TrainfillComponent},
    {path:'trainsearch',component:TrainsearchComponent},
    {path:'trainpage',component:TrainpageComponent},
